...
```
./mammosdoc --template=mammos.md --local --format=html ../magnetic_materials.ttl magnetic_materials.html  
```
...
```
./mammosdoc --template=plots.md --local --format=html ../magnetic_materials.ttl plots.html  
```
